...
# Nom de ton Google Sheet principal
SHEET_NAME = "Ma Base de Données Musicale IA Planétaire"
...
# Clé API Gemini
# DOIT ÊTRE STOCKÉE DANS .streamlit/secrets.toml
# Exemple de contenu de .streamlit/secrets.toml:
# GEMINI_API_KEY="AIzaSy...vHk"
GEMINI_API_KEY_NAME = "GEMINI_API_KEY"

# --- Noms des Onglets de ton Google Sheet (DOIVENT correspondre EXACTEMENT) ---
WORKSHEET_NAMES = {
...
# Ceci est crucial pour sheets_connector.py pour s'assurer que les données sont bien structurées
EXPECTED_COLUMNS = {
