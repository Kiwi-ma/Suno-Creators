...
def save_uploaded_file(uploaded_file, target_dir):
    ...
    if uploaded_file is not None:
        ...
        # Préfère un nom unique pour éviter les conflits si plusieurs fichiers ont le même nom
        ...
        try:
            ...
            return os.path.join(os.path.basename(target_dir), unique_filename) # Retourne le chemin relatif
